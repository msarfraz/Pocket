...
namespace Pocket.Common
{
    public static class Util
    {
        ...
        public static T Package<T>(object data, int totalRecords = 1, int totalPages = 1, int pageIndex=0) where T:JsonResult
        {
            ...
            JsonResult ret = new JsonResult(jsonData); // Activator.CreateInstance<T>();
        ...
        public static Array ToMobileExpenses(IEnumerable<Expense> expenses, string userid)
        {
