...
namespace Pocket.Controllers
{
    ...
    {
        public FriendController(ApplicationDbContext
        ...
        public ActionResult Index([Bind( "Email")] string Email)
        {
        ...
        private string SearchUser(string Email)
        {
            ...
            if (u != null)
            {
                Friend f = db.Users.Find(UserID).Friends.SingleOrDefault(fr => fr.FriendID == u.Id);
                if (f == null)
                {
                    f = new Friend();
                    f.UserID = UserID;
                    ...
                    db.Friends.Add(f);
                    NotificationManager.AddFriendNotification(u.Id, db, UserID, UserName);
                    db.SaveChanges();
                    return string.Empty;
                }
                else
        ...
        {
            int ResourceID = Util.ParseInt(Request.Form["ResourceID"]);
            SharedResourceType ResourceType = (SharedResourceType)Util.ParseInt(Request.Form["ResourceType"]);
                    ...
                    case SharedResourceType.Event:
                        ...
                        if (ev != null)
                        {
                            if (Shared)
                            {
                                ...
                                NotificationManager.AddEventShareNotification(ev.EventID, ev.Name, FriendID, db, UserID, UserName);
                                db.SaveChanges();
                            ...
                            else
                            {
                                ...
                                if (eu != null)
                                {
                                    ...
                                    NotificationManager.RemoveEventShareNotification(ev.EventID, ev.Name, FriendID, db, UserID, UserName);
                                    db.SaveChanges();
                                }
                    ...
                    case SharedResourceType.Account:
                        ...
                        if (acc != null)
                        {
                            if (Shared)
                            {
                                ...
                                NotificationManager.AddAccountShareNotification(acc.AccountID, acc.Name, FriendID, db, UserID, UserName);
                                db.SaveChanges();
                                return Json(new StatusCodeResult(StatusCodes.Status200OK));
                            ...
                            else
                            {
                                ...
                                if (au != null)
                                {
                                    ...
                                    NotificationManager.RemoveAccountShareNotification(acc.AccountID, acc.Name, FriendID, db, UserID, UserName);
                                    db.SaveChanges();
                                }
                        ...
                        if (cat != null)
                        {
                            ...
                            if (Shared)
                            {
                                if (cu == null)
                                {
                                    ...
                                    NotificationManager.AddCategoryShareNotification(cat.CategoryID, cat.Name, FriendID, db, UserID, UserName);
                                    db.SaveChanges();
                                    return Json(new StatusCodeResult(StatusCodes.Status200OK));
                            ...
                            else
                            {
                                if (cu != null)
                                {
                                    ...
                                    NotificationManager.RemoveCategoryShareNotification(cat.CategoryID, cat.Name, FriendID, db, UserID, UserName);
                                    db.SaveChanges();
                                }
