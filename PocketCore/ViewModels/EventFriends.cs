...
namespace Pocket.ViewModels
{
    ...
    {
        public EventFriends(ApplicationDbContext db, string UserID, int EventID)
       {
        ...
        public void SplitFriends(ApplicationDbContext db)
        {
            if (Friends==null)
            {
                Friends = new List<ApplicationUser>();
        ...
        internal void SetSelectedFriends(ApplicationDbContext db)
        {
