namespace Pocket.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Friend_UserID1 = c.Int(),
                        Friend_FriendID1 = c.Int(),
                    })
                .PrimaryKey(t => t.user_id)
                .ForeignKey("dbo.events", t => t.Event_EventID)
                .ForeignKey("dbo.events", t => t.EventFriends_EventID)
                .ForeignKey("dbo.friends", t => new { t.Friend_UserID, t.Friend_FriendID })
                .ForeignKey("dbo.friends", t => new { t.Friend_UserID1, t.Friend_FriendID1 })
                .Index(t => t.Event_EventID)
                .Index(t => t.EventFriends_EventID)
                .Index(t => new { t.Friend_UserID, t.Friend_FriendID })
                .Index(t => new { t.Friend_UserID1, t.Friend_FriendID1 });
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.users", new[] { "Friend_UserID1", "Friend_FriendID1" }, "dbo.friends");
            DropForeignKey("dbo.users", new[] { "Friend_UserID", "Friend_FriendID" }, "dbo.friends");
            DropForeignKey("dbo.friends", "friend_id", "dbo.users");
            DropForeignKey("dbo.friends", "user_id", "dbo.users");
            ...
            DropIndex("dbo.users", new[] { "Friend_UserID1", "Friend_FriendID1" });
            DropIndex("dbo.users", new[] { "Friend_UserID", "Friend_FriendID" });
            DropIndex("dbo.friends", new[] { "friend_id" });
            DropIndex("dbo.friends", new[] { "user_id" });
