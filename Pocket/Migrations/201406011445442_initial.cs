    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Event_EventID = c.Int(),
                        EventFriends_EventID = c.Int(),
                        Friend_FriendID = c.Int(),
                        Friend_FriendID1 = c.Int(),
                    })
                .PrimaryKey(t => t.user_id)
                .ForeignKey("dbo.events", t => t.Event_EventID)
                .ForeignKey("dbo.events", t => t.EventFriends_EventID)
                .ForeignKey("dbo.friends", t => t.Friend_FriendID)
                .ForeignKey("dbo.friends", t => t.Friend_FriendID1)
                .Index(t => t.Event_EventID)
                .Index(t => t.EventFriends_EventID)
                .Index(t => t.Friend_FriendID)
                .Index(t => t.Friend_FriendID1);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.User_UserID, t.Friend_FriendID })
                .ForeignKey("dbo.users", t => t.User_UserID)
                .ForeignKey("dbo.friends", t => t.Friend_FriendID)
                .Index(t => t.User_UserID)
                .Index(t => t.Friend_FriendID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserFriends", "Friend_FriendID", "dbo.friends");
            DropForeignKey("dbo.UserFriends", "User_UserID", "dbo.users");
            DropForeignKey("dbo.users", "Friend_FriendID1", "dbo.friends");
            DropForeignKey("dbo.users", "Friend_FriendID", "dbo.friends");
            ...
            DropForeignKey("dbo.users", "EventFriends_EventID", "dbo.events");
            ...
            DropIndex("dbo.UserFriends", new[] { "Friend_FriendID" });
            DropIndex("dbo.UserFriends", new[] { "User_UserID" });
            DropIndex("dbo.users", new[] { "Friend_FriendID1" });
            DropIndex("dbo.users", new[] { "Friend_FriendID" });
            ...
            DropIndex("dbo.users", new[] { "EventFriends_EventID" });
