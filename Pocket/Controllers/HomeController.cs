...
namespace Pocket.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var accounts = Global.getAllUserAccountsWithCurrentAmount(db);
        ...
        public JsonResult CustomerRequest(string Name, string Email, string Title, string Type, string Body)
        {
            if (Request.IsAjaxRequest())
            {
                ...
                {
                    cr.UserID = User.Identity.GetUserId();
        ...
        public ActionResult Budget(bool? ConstantBudget)
        {
            ...
            List<CategoryBudgetAmount> catsba = Repository.GetCategoryBudgetAmount(db, Month, Year, ConstantBudget.HasValue?ConstantBudget.Value:false);
            List<EventBudgetAmount> evsba = Global.getEventMonthlyBudgetAmount(db, Month, Year, ConstantBudget.HasValue ? ConstantBudget.Value : false);
